  ...
  try {
    ...
    const createdPreference = await preference.create({
      body: {
        ...
        back_urls: {
          success: `${process.env.NEXT_PUBLIC_URL}/api/mercado-pago/pending`,
          failure: `${process.env.NEXT_PUBLIC_URL}/api/mercado-pago/pending`,
          pending: `${process.env.NEXT_PUBLIC_URL}/api/mercado-pago/pending`,
        },
      },
    })
